...
func TestAccountCommands(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			"Test platdot account generate --secp256k1 --password \"abc\"",
			[]string{"secp256k1", "password"},
			[]interface{}{true, "abc"},
			handleGenerateCmd,
		},
		{
			"Test platdot account generate --sr25519 --password \"abc\"",
			[]string{"sr25519", "password"},
			[]interface{}{true, "abc"},
			handleGenerateCmd,
		},
		{
			"Test platdot account import --secp256k1 --password \"abc\" --privateKey 000000000000000000000000000000000000000000000000000000416c696365",
			[]string{"secp256k1", "password", "privateKey"},
			[]interface{}{true, "abc", "000000000000000000000000000000000000000000000000000000416c696365"},
			handleImportCmd,
		},
		{
			"Test platdot account import --sr25519 --password \"abc\" --privateKey 000000000000000000000000000000000000000000000000000000416c696365",
			[]string{"sr25519", "password", "privateKey"},
			[]interface{}{true, "abc", "0xfa67e5b3c421ac1b9e3d59a74f09fa18f9ad41ec381ba95e5087cb164c03121b"},
			handleImportCmd,
		},
		{
			"Test platdot account list",
			[]string{},
			[]interface{}{},
			handleListCmd,
		},
